...
use HdCarrito\Carrito\CartBundle\Entity\producto;
use HdCarrito\Carrito\CartBundle\Form\productoType;
...
class productoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CartBundle:producto')->findAll();

        return $this->render('CartBundle:producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CartBundle:producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CartBundle:producto')->find($id);
        ...
        return $this->render('CartBundle:producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CartBundle:producto:edit.html.twig', array(
            'entity'      => $entity,
