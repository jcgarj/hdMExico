...
use HdCarrito\Carrito\UserCarritoBundle\Entity\estado;
use HdCarrito\Carrito\UserCarritoBundle\Form\estadoType;
...
class estadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserCarritoBundle:estado')->findAll();

        return $this->render('UserCarritoBundle:estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UserCarritoBundle:estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserCarritoBundle:estado')->find($id);
        ...
        return $this->render('UserCarritoBundle:estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UserCarritoBundle:estado:edit.html.twig', array(
            'entity'      => $entity,
